...
## Changes    
the following changes are ordered by priority of implementation
...
2. **pre_rendering**
In this stage the real buffer will be transformed into a a form that may be displayed onto the screen, this is called the virtual_buffer.
3. **virtual_buffer**
...
4. **rendering**
Once all necessary changes have been compleated in the virtual_buffer, it will be resized if necessary (in case new lines where added) and will be displayed to the user.
